...
public class CheckoutServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            MailService.sendMail(mail, "XAC NHAN DON HANG THANH TOAN THANH CONG!", "CAM ON BAN DA SU DUNG DICH VU APPLEMEOMEO KITCHEN. DON HANG SE DUOC VAN CHUYEN DEN BAN TRONG THOI GIAN SOM NHAT.");
        } catch (Exception e) {
        }
